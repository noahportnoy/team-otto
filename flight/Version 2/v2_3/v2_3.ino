...
*/
  ...
  if( compassStartupFlag == 0){
    yaw_target = ToDeg(heading);
    compassStartupFlag = 1;
  }  
...
//    hal.console->println(yaw_output);
//    hal.console->print("Yaw target: ");
//    hal.console->println(yaw_target);
//    hal.console->print("Yaw: ");
//    hal.console->println(yaw);
//    hal.console->print("RC Yaw: ");
